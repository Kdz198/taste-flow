...
export default function HeaderClient() {
  ...
  const listCard = useSelector((state: RootState) => state.cart.itemsToAdd);
  return (
        ...
        user ? (
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 bg-[#2A2A2A] border-[#3A3A3A] text-white mr-4 mt-2">
              ...
              <DropdownMenuItem onClick={() => handleLogout.mutate()} className="hover:bg-red-600 cursor-pointer text-red-400 hover:text-white">
